...
import {IPriceOracle} from "./AAVE/IPriceOracle.sol";
...
contract Config {
    ...
    IPriceOracle public constant AAVE_PRICE_ORACLE = IPriceOracle(AAVE_PRICE_ORACLE_ADDRESS);
    ...
    AggregatorV3Interface public constant CHAINLINK_APE_USD =
        AggregatorV3Interface(CHAINLINK_APE_USD_AGGREGATOR_ADDRESS);
    AggregatorV3Interface public constant CHAINLINK_ETH_USD =
        AggregatorV3Interface(CHAINLINK_ETH_USD_AGGREGATOR_ADDRESS);
    AggregatorV3Interface public constant CHAINLINK_USDC_USD =
        AggregatorV3Interface(CHAINLINK_USDC_USD_AGGREGATOR_ADDRESS);
}
